...
get_ipython().run_line_magic('data_compression', '31')


# In[8]:


get_ipython().run_line_magic('data_compression', '32')


# In[9]:


get_ipython().run_line_magic('data_compression', '33')


# In[10]:


get_ipython().run_line_magic('data_compression', '34')
