...
# load pre computed features for memory restrictions
...
feature_names = get_column_names_from_ColumnTransformer(ordinal_pipe['preprocess'])
ordinal_pipe['clf'].clf.estimators_[0].get_booster().feature_names = feature_names

import matplotlib.pyplot as plt

fig, ax = plt.subplots(figsize=(20, 10))
xgb.plot_importance(ordinal_pipe['clf'].clf.estimators_[0].get_booster(), ax=ax, max_num_features=50)
plt.show()
