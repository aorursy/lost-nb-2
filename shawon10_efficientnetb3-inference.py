...
if os.path.isfile(os.path.join(pretrained,"efficientNetB3.h5"))         and os.path.isfile(os.path.join(pretrained,"enet.csv")):
...
model = load_model(os.path.join(pretrained, 'efficientNetB3.h5'))
...
df = pd.read_csv(os.path.join(pretrained,'enet.csv'))
