...
get_ipython().run_line_magic('data_compression', '11')


# In[8]:


get_ipython().run_line_magic('data_compression', '12')


# In[9]:


get_ipython().run_line_magic('data_compression', '13')


# In[10]:


get_ipython().run_line_magic('data_compression', '14')


# In[11]:


get_ipython().run_line_magic('data_compression', '15')
