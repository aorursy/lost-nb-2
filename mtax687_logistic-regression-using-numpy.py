...
d = model(train_images, train_labels, dev_images, dev_labels, num_iterations = 2000, learning_rate = 0.0005, print_cost = True)
plt_costs(d)
...
d = model(train_images, train_labels, dev_images, dev_labels, num_iterations = 200, learning_rate = LEARNING_RATE, print_cost = True)
plt_costs(d)
...
predict_test_images(file_count=12500)
...
d = model(train_images, train_labels, dev_images, dev_labels, num_iterations = 200, learning_rate = 0.003, print_cost = True)
plt_costs(d)
...
dev_images, train_images = split_data(images, split_ratio=DEV_RATIO)
dev_labels, train_labels = split_data(labels, split_ratio=DEV_RATIO)
print("end split {} data:{}".format(m,datetime.datetime.now()))
