...
train_df[train_df.logerror>0.46]
...
sns.barplot(cnt_srs.index, cnt_srs.values, alpha=0.9, color=color[2])
...
X_train, X_test, y_train, y_test = train_test_split(train_df, train_y, test_size=0.7)
