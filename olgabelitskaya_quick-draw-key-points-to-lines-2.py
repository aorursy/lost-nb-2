...
get_ipython().run_line_magic('data_compression', '6')


# In[8]:


get_ipython().run_line_magic('data_compression', '7')


# In[9]:


get_ipython().run_line_magic('data_compression', '8')


# In[10]:


get_ipython().run_line_magic('data_compression', '9')


# In[11]:


get_ipython().run_line_magic('data_compression', '10')
