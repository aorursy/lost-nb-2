...
get_ipython().run_line_magic('data_compression', '26')


# In[7]:


get_ipython().run_line_magic('data_compression', '27')


# In[8]:


get_ipython().run_line_magic('data_compression', '28')


# In[9]:


get_ipython().run_line_magic('data_compression', '29')


# In[10]:


get_ipython().run_line_magic('data_compression', '30')
