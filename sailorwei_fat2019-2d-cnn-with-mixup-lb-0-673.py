...
model_path = '../working/weight_best_2s_%(m)s_%(lr)s_%(aug)s.pt'% {'m':model_type, 'lr':lr_method, 'aug':aug_flip}
output_path = '../working/submission_2s_%(m)s_%(lr)s_%(aug)s.csv'%{'m':model_type, 'lr':lr_method, 'aug':aug_flip}
print(model_path)
...
model_path = '../input/outputmodels2/weight_best_2s_inception_cosine_flip.pt'
