...
get_ipython().run_line_magic('data_compression', '21')


# In[8]:


get_ipython().run_line_magic('data_compression', '22')


# In[9]:


get_ipython().run_line_magic('data_compression', '23')


# In[10]:


get_ipython().run_line_magic('data_compression', '24')


# In[11]:


get_ipython().run_line_magic('data_compression', '25')
