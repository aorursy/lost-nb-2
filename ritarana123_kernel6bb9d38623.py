...
weather=pd.read_csv("../input/weather-data/training_data_with_weather_info_week_2.csv")
...
train_df = pd.read_csv('../input/weather-data/training_data_with_weather_info_week_2.csv', parse_dates=['Date'])
