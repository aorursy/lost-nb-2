...
get_ipython().run_line_magic('data_compression', '16')


# In[8]:


get_ipython().run_line_magic('data_compression', '17')


# In[9]:


get_ipython().run_line_magic('data_compression', '18')


# In[10]:


get_ipython().run_line_magic('data_compression', '19')


# In[11]:


get_ipython().run_line_magic('data_compression', '20')
